...
cookbook 'opsworks_rails_helpers', git: 'https://github.com/wmcinc/opsworks-rails-helpers.git'
cookbook 'opsworks_bower', git: 'https://github.com/wmcinc/opsworks-bower.git'
